...
- This is the home screen which has two buttons
    ...
    - One to sign up
### Register Page
![Register- State 1](/Gator-Dater/screenshots/create.png)
...
### Login Page
![Log In- State 1](/Gator-Dater/screenshots/login.png)
- Logs the user in by using the user password and username
- If success then the user will be redirected to their profile page
### Main Page
![Profile Page- State 1](/Gator-Dater/screenshots/profile1.png)
...
![Edit Profile Page- State 1](/Gator-Dater/screenshots/edit&signup_profile.png)
